...
class Test1(unittest.TestCase):  # pylint: disable=R0904
    ...
    def test_find_text_lines(self):
        """
        Tests find_text_lines.
        """
        path = os.path.join('..', 'texts', 'cdli_text.txt')
        f_i = FileImport(path)
        f_i.read_file()
