...
from ATFConverter.cdli_import import CDLIImport # pylint: disable =import-error
...
18. in ki-ib-ra-tim"""
    ...
    def test_cdli_pull(self):
        """
        Tests __cdli_pull__.
        """
        cdli = CDLIImport()
        pnumber = '&P254202'
        output = cdli.__cdli_pull__(pnumber)
        goal = \
"""&P254202 = ARM 01, 001
#atf: lang akk
@tablet
...
15'. [a-na na-pa]-asz2#-ti-ia i-tu-ur"""
    ...
    def test_file_pull(self):
        ...
        cdli = CDLIImport()
        pnumber = '&P254202'
        output = cdli.__file_pull__('cdli_text.txt', pnumber)
        goal = \
"""&P254202 = ARM 01, 001
#atf: lang akk
@tablet
...
15'. [a-na na-pa]-asz2#-ti-ia i-tu-ur"""
    ...
    def test_import_text(self):
        ...
        cdli = CDLIImport()
        pnumber = '&P254202'
        output = cdli.import_text(pnumber)
        goal = \
"""&P254202 = ARM 01, 001
#atf: lang akk
@tablet
