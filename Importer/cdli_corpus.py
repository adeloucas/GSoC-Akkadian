...
class CDLICorpus(object):
    ...
    def __chunk_text__(self, file_lines):     # pylint: disable =no-self-use
        """
    ...
    def __find_edition__(self, file_lines):
        """
    ...
    def __find_metadata__(self, file_lines):
        """
    ...
    def __find_transliteration__(self, file_lines):  # broken
        """
    ...
    def __ingest__(self, file_lines):
        """
        ...
        functions.
        """
        cdli_number = self.__find_cdli_number__(file_lines)
        edition = self.__find_edition__(file_lines)
        metadata = self.__find_metadata__(file_lines)
        transliteration = self.__find_transliteration__(file_lines)
    ...
    def ingest_text_file(self, file_lines):
        ...
        functions.
        """
        for text_lines in self.__chunk_text__(file_lines):
            self.__ingest__(text_lines)
            texts = self.text
